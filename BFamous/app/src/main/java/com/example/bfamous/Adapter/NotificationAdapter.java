package com.example.bfamous.Adapter;
...
import com.koddev.instagramtest.PostDetail;
import com.koddev.instagramtest.ProfileFrag;
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (notification.isIspost()) {
                   ...
                   //startActivity(new Intent(Notification.this, PostActivity.class));
                } else {
                    SharedPreferences.Editor editor = mContext.getSharedPreferences("PREFS", MODE_PRIVATE).edit();
                    editor.putString("profileid", notification.getUserid());
                    editor.apply();

                    mContext.startActivity(new Intent(mContext, ProfileFrag.class));
                   // ((FragmentActivity)mContext).getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
